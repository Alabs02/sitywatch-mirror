...
const Gists: React.FC = () => {
  ...
  return (
    <div className="px-6 grid grid-cols-12 gap-x-6 overflow-y-auto">
      {gists.map((gist: Gist) => (
        <section key={gist.id} className="grid col-span-8">
          ...
          <div className="w-full h-full bg-slate-100 mt-8 rounded-md border border-slate-200 shadow-sm">
            ...
            <div className="">
              <p className="text-sm px-2">
                #HiFL2023 N200,000 up for grabs this season for a lucky winner.
                All you have to do is make a cov...{" "}
              </p>
              <img
