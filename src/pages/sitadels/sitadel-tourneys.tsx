...
import SitadelTourneyssCarousel from "@/components/contents/sitadel-profile-components/SitadelTourneysCarousel"
...
const Tourneys: React.FC = () => {
  ...
  useEffect(() => {
    ...
    router.push({ pathname: "/sitadels/sitadel-tourneys", query })
  }, [])
