    ...
    <div className="min-h-screen flex flex-col relative px-0 lg:px-8">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        >
          ...
          >
            <i className="material-symbols-outlined text-white">draft_orders</i>
            {!isCollapsed ? (
              <span className="hidden xl:inline text-white">Drop a gist</span>
            ) : null}
          </button>
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className={clsx(
              "flex-1 overflow-y-auto absolute top-0 left-0 right-0 bottom-0 mt-[1.5rem] mx-2", // Added mx-2 for small and md screens
              isCollapsed
                ? "ml-0 md:ml-1" // Adjusted margin for collapsed state to prevent overlap
                : "ml-0 md:ml-2 lg:ml-[calc(80px+24px)] xl:ml-[calc(215px+24px)]",
            )}
          >
            {children}
          </motion.div>
