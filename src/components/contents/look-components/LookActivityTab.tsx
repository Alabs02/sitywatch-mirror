      ...
      <div className="">
        <div className="h-full mb-8 overflow-y-auto">
          <div className="w-full h-full bg-neutral-300 mt-8 rounded-md border border-slate-200 shadow-sm">
            <div className="flex items-center p-2">
              ...
              <div className="flex flex-col my-2">
                <div className="flex space-x-2 items-center">
                  ...
                  <span className="inline-flex h-2 w-2 p-1 rounded-full bg-blue-500 m-0"></span>
                  {/* <span className="text-secondary text-[12px] font-bold m-0 p-0">
                    #SWPA_SC2023
                  </span> */}
                </div>
            ...
            <div className="">
                <span className="mb-2 mx-auto text-center text-sm">Brown shade on brown skin is the new bae. The glow is classy</span>
              <img
                src="/spicyq-mk.gif"
                alt="Hufl"
...
export default LookActivityTab
