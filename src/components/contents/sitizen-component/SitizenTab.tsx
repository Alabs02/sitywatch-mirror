        ...
        >
          ...
          <div className="flex flex-col flex-grow">
            <div className="flex items-center justify-between">
              ...
              <button
                className={clsx(
                  "flex items-center justify-center rounded-full px-4 py-1 text-xs md:text-sm font-bold h-8 md:h-10 w-24 md:w-28",
                  notification.id % 2 === 0
                    ? "bg-gradient-to-r from-[#F24055] to-[#1E7881] text-white"
                    : "border-2 border-primary-500 text-primary-500 bg-transparent",
                )}
              >
                {notification.id % 2 === 0 ? "WATCH" : "WATCHING"}
              </button>
            </div>
