...
const SoulPanda = () => {
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center bg-neutral-100 p-2 my-4 rounded-lg text-xs md:text-sm">
        ...
        <div className="flex flex-col w-full mx-auto items-center place-content-center my-2">
          <button className="rounded-full text-[10px] md:text-[12px] px-[42%] py-[2%] flex items-center mb-4 text-neutral-100 font-semibold bg-gradient-to-b from-[#F24055] to-[#1E7881] hover:bg-transparent border border-[#F24055]">
            <span className="material-symbols-outlined text-lg mr-1">
              send_money
            </span>{" "}
            PANDAR
          </button>
          <button className="rounded-full text-[10px] md:text-[12px] px-[42%] py-[2%] inline-flex items-center mb-4 text-[#F24055] font-semibold border border-[#F24055] hover:bg-gradient-to-b hover:from-[#F24055] hover:to-[#1E7881] hover:text-white">
            VIEW POLL
          </button>
        </div>
      </div>
