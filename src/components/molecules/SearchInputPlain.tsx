    ...
    <form onSubmit={handleSubmit} className="flex flex-col mx-auto">
      <div className="relative w-full">
        <input
          ...
          className="w-full rounded-lg px-3 py-2 bg-gradient-to-r from-tertiary-100 to-neutral-100 shadow-inner shadow-gray-600/50 focus:outline-none focus:ring-1 focus:ring-blue-500 text-sm lg:text-base"
